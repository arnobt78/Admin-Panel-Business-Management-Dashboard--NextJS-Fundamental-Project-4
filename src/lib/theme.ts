/**
 * Theme configuration and color mode context.
 * Uses MUI createTheme with design tokens for light/dark modes.
 */
import { createContext, useState, useMemo } from "react";
import { createTheme } from "@mui/material/styles";
import type { PaletteMode, ColorModeContextValue } from "@/types";

/** Color token scale (100-900) for grey, primary, accents */
